  ...
  async function handleSubmitDetails(e: React.FormEvent) {
    ...
    if (!id) {
      const rec = createStudent({
        name: details.name || studentName || "Unnamed",
      });
      id = rec.id;
    }
    updateDetails(id!, {
    ...
    toast({
      title: "Member saved",
      description: "Details stored locally (demo).",
    });
  }
                      ...
                      <ul className="space-y-2 text-sm">
                        {absentees.map((s) => {
                          ...
                          const wa = formatWhatsAppLink(
                            s.details.parentContact || s.details.studentContact,
                            msg,
                          );
                          return (
                            <li
                            ...
                            >
                              ...
                              <div className="flex gap-2">
                                ...
                                <a
                                  className="text-primary underline"
                                  href={`sms:${(s.details.parentContact || s.details.studentContact).replace(/[^0-9]/g, "")}?&body=${encodeURIComponent(msg)}`}
                                >
                                  SMS
                                </a>
                              </div>
            ...
            >
              <div className="lg:col-span-2 space-y-4">
                <Card>
                  <CardHeader>
                    <CardTitle className="flex items-center gap-2">
                      <GraduationCap className="h-5 w-5" /> Add Member Details
                    </CardTitle>
                    <CardDescription>
                      Fill student information. On submit, data is stored
                      locally and mirrored to student view (except password).
                    </CardDescription>
                  </CardHeader>
                ...
                <Card>
                  <CardHeader>
                    <CardTitle className="flex items-center gap-2">
                      <UploadCloud className="h-5 w-5" /> Uploads
                    </CardTitle>
                    <CardDescription>
                      Upload profile photo and documents (ID proof, admission
                      letter, etc.).
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
              ...
              <div className="space-y-4">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Load an existing member to edit.
                    </CardDescription>
                  </CardHeader>
                      ...
                      onValueChange={(v) => {
                        ...
                        if (s)
                          setDetails({
                            ...
                            totalAmount:
                              s.details.totalAmount?.toString() || "",
                            joiningDate: s.details.joiningDate,
                            profilePhotoDataUrl:
                              s.details.profilePhotoDataUrl || "",
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      What students can see (without password).
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    {selected ? (
                      <div className="space-y-2 text-sm">
                        ...
                        <div className="mt-2">
                          Parent: {selected.details.parentName || "-"}
                        </div>
                        <div>
                          Parent Contact:{" "}
                          {selected.details.parentContact || "-"}
                        </div>
                        <div>
                          Student Contact:{" "}
                          {selected.details.studentContact || "-"}
                        </div>
                        <div>Email: {selected.details.email || "-"}</div>
                        <div>Address: {selected.details.address || "-"}</div>
                        <div>
                          Total Amount: {selected.details.totalAmount ?? "-"}
                        </div>
                        <div>
                          Joining Date: {selected.details.joiningDate || "-"}
                        </div>
